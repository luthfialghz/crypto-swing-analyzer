...
import { Share2, Activity, Wifi, WifiOff, RefreshCw, Clock, Send, Bot, Zap } from 'lucide-react';
    ...
    <PortfolioProvider>
      <main className="min-h-screen px-6 py-10 max-w-7xl mx-auto">
        ...
        {isRefreshing && data.length === 0 ? (
         ...
         {/* Discord Notification Test Section - Hidden */}
         <div className="hidden">
           <div className="mt-12 rounded-3xl border border-slate-700/50 bg-slate-900/40 p-8 backdrop-blur-xl">
             <div className="flex items-center justify-between mb-6">
               <div>
                 ...
                 <p className="text-slate-400 text-sm mt-1">
                   Test automatic notifications to your Discord channel
                 </p>
               </div>
             </div>
